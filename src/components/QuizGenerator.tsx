    ...
    try {
      ...
      const drawHeader = (isFirstPage: boolean) => {
        if (isFirstPage) {
          ...
          doc.setFontSize(8.5);
          doc.text('HELPYOU AI  |  AUTHENTIC AP CURRICULUM QUIZ ASSESSMENT', margin, 24);
          ...
          doc.text(`Total Questions: ${quiz.length}  |  Score: ${score}/${quiz.length} (${Math.round((score/quiz.length)*100)}%)  |  Generated by HelpYou AI`, margin, 64);
          currentY = 96;
        } else {
          ...
          doc.text(`HelpYou AI AP Quiz: ${topic || 'Practice Assessment'}`, margin, 18);
          currentY = 44;
        }
      };
      ...
      const drawFooter = (pageNum: number) => {
        ...
        doc.text('For step-by-step interactive AI hints & audio tutoring, practice on HelpYou AI', margin, pageHeight - 10);
